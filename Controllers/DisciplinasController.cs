...
namespace p2.Controllers
{
    public class DisciplinasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Descricao")] Disciplina disciplina)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Descricao")] Disciplina disciplina)
        {
            if (id != disciplina.Id)
            {
                return NotFound();
